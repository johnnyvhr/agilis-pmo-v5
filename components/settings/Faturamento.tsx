      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 bg-slate-50 dark:bg-slate-700 p-6 rounded-lg">
          ...
          <div className="mt-4 flex space-x-3">
            <button onClick={() => alert('Funcionalidade indisponível.')} className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 font-medium text-sm">
                Alterar Plano
            </button>
             <button onClick={() => alert('Funcionalidade indisponível.')} className="px-4 py-2 bg-white dark:bg-slate-600 border border-slate-300 dark:border-slate-500 text-slate-700 dark:text-slate-200 rounded-md hover:bg-slate-100 dark:hover:bg-slate-500 font-medium text-sm">
                Cancelar Assinatura
            </button>
          </div>
        </div>
        ...
        <div className="bg-slate-50 dark:bg-slate-700 p-6 rounded-lg">
           ...
           <button onClick={() => alert('Funcionalidade indisponível.')} className="w-full px-4 py-2 border border-slate-300 dark:border-slate-500 text-slate-700 dark:text-slate-200 rounded-md hover:bg-slate-100 dark:hover:bg-slate-600 font-medium text-sm">
