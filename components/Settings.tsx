  ...
  const renderMainSettings = () => (
    <>
      <div className="flex justify-between items-center mb-8">
        ...
        <button 
            onClick={onClose} 
            className="flex items-center space-x-2 px-4 py-2 bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-200 rounded-md hover:bg-slate-50 dark:hover:bg-slate-600 text-sm font-medium"
        >
